...
namespace OneForAll.File
{
    ...
    /// 图片类型验证
    /// </summary>
    public class ValidateImageType : IValidateImageType
    {
        /// <summary>
        /// 验证（文件名、文件类型）
        /// </summary>
        ...
        {
            return FileHelper.ValidateFileType<ImageTypeEnum>(file);
        }
        ...
        {
            return FileHelper.ValidateFileName<ImageTypeEnum>(fileName);
        }
    }
}
